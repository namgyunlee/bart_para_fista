...
DEF_TYPEID(iter_para_fista_conf); // Para-FISTA: Modified by Nam Gyun Lee 2023-05-22
...
const struct iter_para_fista_conf iter_para_fista_defaults = {

	.INTERFACE.TYPEID = &TYPEID2(iter_para_fista_conf),
	.INTERFACE.alpha = 1.,
...
// Para-FISTA: Modified by Nam Gyun Lee 2023-05-22
void iter_para_fista(iter_conf* _conf,
	const struct operator_s* normaleq_op,
	const struct operator_p_s* thresh_prox,
	long size, float* image, const float* image_adj,
	struct iter_monitor_s* monitor)
{
	iter2_para_fista(_conf, normaleq_op, 1, &thresh_prox, NULL, NULL, NULL, size, image, image_adj, monitor);
}
