...
int main_pics(int argc, char* argv[argc])
{
	...
	const struct opt_s opts[] = {
		...
		OPTL_SELECT(0, "para_fista", enum algo_t, &algo, ALGO_PARAFISTA, "select Para-FISTA"), // Modified by Nam Gyun Lee 2023-05-22
	...
	if ((ALGO_IST == algo) || (ALGO_FISTA == algo) || (ALGO_PRIDU == algo) || (ALGO_PARAFISTA == algo)) { // Modified by Nam Gyun Lee 2023-05-22
